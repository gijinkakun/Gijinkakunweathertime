...
public class DependencyInjectionModule extends AbstractModule {
    ...
    private final FileConfiguration fallbackMessageConfig;
    ...
    public DependencyInjectionModule(
        ...
        FileConfiguration fallbackMessageConfig
    ) {
        this.plugin = plugin;
        this.config = config;
        this.messageConfig = messageConfig;
        this.fallbackMessageConfig = fallbackMessageConfig;
    }
    ...
    protected void configure() {
        ...
        bind(MessageService.class).toInstance(new MessageService(messageConfig, fallbackMessageConfig, plugin.getLogger()));
